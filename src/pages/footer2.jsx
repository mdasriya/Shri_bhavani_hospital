    ...
    >
      ...
      >
        <Flex flexWrap="wrap" alignItems="start" justifyContent="space-between">
          ...
          <Box w={{ base: '100%', sm: '50%', md: 'max-content' }} mb={{ base: '1.5rem', lg: '0' }}>
            <Heading as="h5" color="rgb(46,86,104)" mb="0.5rem" fontSize="0.875rem" fontWeight="600">
              Hosting
            </Heading>
            <List lineHeight="2">
      ...
      <Flex maxW="64rem" mx="auto" alignItems="center" px={10}>
        ...
        <Text color="white" fontSize="0.975rem" pl="0.5rem" >
        © Copyright Shri Bhavani Multi-Speciality Hospital. All Rights Reserved
Managed By PDigiWorld
        </Text>
      </Flex>
    </Box>
  );
